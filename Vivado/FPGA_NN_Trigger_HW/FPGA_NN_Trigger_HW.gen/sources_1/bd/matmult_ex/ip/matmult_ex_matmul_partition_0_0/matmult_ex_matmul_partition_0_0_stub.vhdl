...
-- Date        : Thu Feb 20 14:38:56 2025
-- Host        : TABLET-60QL2L1F running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top matmult_ex_matmul_partition_0_0 -prefix
--               matmult_ex_matmul_partition_0_0_ matmult_ex_matmul_partition_0_0_stub.vhdl
-- Design      : matmult_ex_matmul_partition_0_0
...
entity matmult_ex_matmul_partition_0_0 is
  Port ( 
...
architecture stub of matmult_ex_matmul_partition_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of ap_clk : signal is "XIL_INTERFACENAME ap_clk, ASSOCIATED_BUSIF s_axi_control:m_axi_gmem, ASSOCIATED_RESET ap_rst_n, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN matmult_ex_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_MODE of dim : signal is "slave";
  attribute X_INTERFACE_PARAMETER of dim : signal is "XIL_INTERFACENAME dim, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of rep_count : signal is "xilinx.com:signal:data:1.0 rep_count DATA";
  attribute X_INTERFACE_MODE of rep_count : signal is "slave";
  attribute X_INTERFACE_PARAMETER of rep_count : signal is "XIL_INTERFACENAME rep_count, LAYERED_METADATA undef";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of stub : architecture is "matmul_partition,Vivado 2024.2";
begin
end;
