...
// Command     : write_verilog -force -mode synth_stub -rename_top matmult_ex_matmul_partition_0_0 -prefix
//               matmult_ex_matmul_partition_0_0_ matmult_ex_matmul_partition_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "matmult_ex_matmul_partition_0_0,matmul_partition,{}" *) (* CORE_GENERATION_INFO = "matmult_ex_matmul_partition_0_0,matmul_partition,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=matmul_partition,x_ipVersion=1.0,x_ipCoreRevision=2113963449,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CONTROL_ADDR_WIDTH=6,C_S_AXI_CONTROL_DATA_WIDTH=32,C_M_AXI_GMEM_ID_WIDTH=1,C_M_AXI_GMEM_ADDR_WIDTH=64,C_M_AXI_GMEM_DATA_WIDTH=32,C_M_AXI_GMEM_AWUSER_WIDTH=1,C_M_AXI_GMEM_ARUSER_WIDTH=1,C_M_AXI_GMEM_WUSER_WIDTH=1,C_M_AXI_GMEM_RUSER_WIDTH=1,C_M_AXI_GMEM_BUSER_WIDTH=1,C_M_AXI_GMEM_USER_VALUE=0x00000000,C_M_AXI_GMEM_PROT_VALUE=000,C_M_AXI_GMEM_CACHE_VALUE=0011}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "matmul_partition,Vivado 2024.2" *) (* hls_module = "yes" *) 
module matmult_ex_matmul_partition_0_0(s_axi_control_ARADDR, 
  ...
  m_axi_gmem_WVALID, dim, rep_count)
...
/* synthesis syn_force_seq_prim="ap_clk" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 dim DATA" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME dim, LAYERED_METADATA undef" *) input [31:0]dim;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 rep_count DATA" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME rep_count, LAYERED_METADATA undef" *) input [31:0]rep_count;
endmodule
