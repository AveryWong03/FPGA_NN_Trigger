...
architecture behav of matmul_partition is 
    ...
    "matmul_partition_matmul_partition,hls_ip_2024_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=815,HLS_SYN_TPT=none,HLS_SYN_MEM=5,HLS_SYN_DSP=0,HLS_SYN_FF=9189,HLS_SYN_LUT=7450,HLS_VERSION=2024_2}";
    ...
    signal trunc_ln23_1_fu_373_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal trunc_ln23_1_reg_518 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal trunc_ln23_fu_382_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal trunc_ln23_reg_557 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal trunc_ln23_1_fu_373_p0 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                ...
                trunc_ln23_1_reg_518 <= trunc_ln23_1_fu_373_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state4)) then
                ...
                trunc_ln23_reg_557 <= trunc_ln23_fu_382_p1;
    ...
    smax2_fu_450_p3 <= 
        trunc_ln23_reg_557 when (empty_27_fu_445_p2(0) = '1') else 
        ap_const_lv31_0;
    smax_fu_438_p3 <= 
        trunc_ln23_1_reg_518 when (empty_26_fu_433_p2(0) = '1') else 
        ap_const_lv31_0;
    trunc_ln23_1_fu_373_p0 <= dim;
    trunc_ln23_1_fu_373_p1 <= trunc_ln23_1_fu_373_p0(31 - 1 downto 0);
    trunc_ln23_fu_382_p1 <= rep_count(31 - 1 downto 0);
